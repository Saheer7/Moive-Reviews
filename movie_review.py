...
def process_csv():
    ...
    ##############################TRAIN DATA#####################
    with open('D:\\My projects\\Movie review\\train.tsv\\train.tsv', 'r') as f:
    ...
    with open('D:\\My projects\\Movie review\\test.tsv\\test.tsv', 'r') as f:
        testreader = csv.reader(f, delimiter='\t')
        submission = open('scikit_submission.csv', 'w') #Name of submission file
